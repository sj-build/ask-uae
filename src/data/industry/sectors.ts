...
export const sectors: readonly Sector[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    players: [
      { name: 'First Abu Dhabi Bank', owner: 'Mubadala/IHC', revenueUsd: '$9.2B', marketCapUsd: '$52B', valueChainPosition: '상업은행', note: 'UAE 1위, GCC 최대 은행' },
      { name: 'Emirates NBD', owner: 'ICD/Dubai 정부', revenueUsd: '$7.8B', marketCapUsd: '$35B', valueChainPosition: '상업은행', note: 'UAE 2위, DenizBank 소유' },
      { name: 'Abu Dhabi Commercial Bank', owner: '정부 61%', revenueUsd: '$4.2B', marketCapUsd: '$18B', valueChainPosition: '상업은행', note: 'UAE 3위' },
      { name: 'Dubai Islamic Bank', owner: 'ICD', revenueUsd: '$3.5B', marketCapUsd: '$12B', valueChainPosition: '이슬람은행', note: '세계 최대 이슬람은행' },
  ...
  },
  {
    ...
    players: [
      { name: 'Binance (VARA)', owner: 'CZ/MGX $2B', revenueUsd: '$12B+', marketCapUsd: '$80B+', valueChainPosition: '거래소', note: 'Dubai 본사, VASP 라이선스' },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    players: [
      { name: 'ADNOC', owner: 'Abu Dhabi 정부', revenueUsd: '$49.7B', marketCapUsd: '$90B+', valueChainPosition: 'Upstream', note: '세계 12위 원유 매장, 한국 $30B+ 계약' },
  ...
  },
  {
    ...
    players: [
      ...
      { name: 'Modon', owner: 'IHC 자회사', revenueUsd: '$5.5B+', marketCapUsd: '', valueChainPosition: '디벨로퍼', note: 'Saadiyat, Yas Bay 개발' },
    ],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    players: [
      { name: 'Chalhoub Group', owner: 'Chalhoub 가문', revenueUsd: '$3-5B', marketCapUsd: '비상장', valueChainPosition: '유통', note: 'LVMH, Chanel, Dior 독점유통' },
      { name: 'Al Tayer Group', owner: 'Al Tayer 가문', revenueUsd: '$8B', marketCapUsd: '비상장', valueChainPosition: '유통/리테일', note: "Harvey Nichols, Bloomingdale's" },
      { name: 'Majid Al Futtaim', owner: 'MAF Group', revenueUsd: '$9.2B', marketCapUsd: '비상장', valueChainPosition: '리테일/몰', note: 'Carrefour, Mall of Emirates' },
  ...
  },
  {
    ...
    players: [
      { name: 'Chalhoub (Sephora)', owner: 'Chalhoub 가문', revenueUsd: '$3-5B', marketCapUsd: '비상장', valueChainPosition: '유통/리테일', note: "Dior, Chanel, L'Oreal 독점" },
      { name: 'Faces (Al Tayer)', owner: 'Al Tayer 가문', revenue: '~80개점', marketCapUsd: '비상장', valueChainPosition: '리테일', note: '뷰티 편집숍 체인' },
      { name: 'Huda Beauty', owner: 'Huda Kattan', revenueUsd: '$200M+', marketCapUsd: '비상장', valueChainPosition: '브랜드/제조', note: 'Dubai 기반 글로벌 인디 브랜드' },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    players: [
      { name: 'EDGE Group', owner: 'UAE 정부', revenueUsd: '$5B', marketCapUsd: '', valueChainPosition: '방위 제조', note: '세계 22위 방위산업' },
