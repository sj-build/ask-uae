...
export const comparisonStats: readonly ComparisonRow[] = [
  { indicator: '정치체제', uae: '연방 절대군주제 (7개 에미리트)', korea: '대통령제 민주공화국', note: 'UAE는 선거·정당·의회 없는 왕정' },
  ...
  { indicator: '인구', uae: '~1,050만', korea: '~5,170만', note: 'UAE 인구의 88.5%가 외국인', uaeHighlight: true },
  { indicator: '자국민 인구', uae: '~120만 (11.5%)', korea: '~5,170만', note: '실제 에미라티는 부산 인구의 1/3 수준', uaeColor: 'red' },
  ...
  { indicator: '1인당 GDP', uae: '$49,500', korea: '$33,100', note: 'UAE가 1.5배 높음', uaeColor: 'green' },
  { indicator: 'GDP 성장률', uae: '4.0% (2024)', korea: '2.0% (2024)', note: 'UAE 목표: 4.8% (2025), 5.7% (2026)' },
  { indicator: '국부펀드(SWF) 총자산', uae: '$2.5T+', korea: '$890B (KIC+NPS)', note: 'UAE SWF = 한국 GDP의 1.5배', uaeHighlight: true },
  { indicator: '소득세', uae: '0% (면세)', korea: '6~45% 누진세', note: '법인세: UAE 9% (2023~), 한국 9~24%', uaeColor: 'green' },
  ...
  { indicator: '양자 관계', uae: 'CEPA 발효 (2024.5) · 100년 전략적 파트너십', korea: '', note: 'KEPCO 원전 $23.8B, 삼성엔지니어링 $8B+' },
] as const
