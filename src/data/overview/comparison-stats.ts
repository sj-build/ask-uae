...
export const comparisonStats: readonly ComparisonRow[] = [
  ...
  { indicator: '1인당 GDP', uae: '$49,500', korea: '$33,100', note: 'UAE가 1.5배 높음', uaeColor: 'green', whyItMatters: '고소득 시장. 프리미엄 제품/서비스 가격 책정 가능. 소비력 높은 중동 허브.' },
  ...
  { indicator: '소득세', uae: '0% (면세)', korea: '6~45% 누진세', note: '법인세: UAE 9% (2023~), 한국 9~24%', uaeColor: 'green', whyItMatters: '법인세 9%+소득세 0%로 세금 부담 최소화. 다만 VAT 5%, 프리존 밖 사업시 비용 고려 필요.' },
