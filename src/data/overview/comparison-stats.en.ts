...
export const comparisonStats: readonly ComparisonRow[] = [
  ...
  { indicator: 'GDP per Capita', uae: '$49,500', korea: '$33,100', note: 'UAE is 1.5x higher', uaeColor: 'green', whyItMatters: 'High-income market enables premium pricing. Strong purchasing power in the Middle East hub.' },
  ...
  { indicator: 'Income Tax', uae: '0% (Tax-free)', korea: '6~45% Progressive', note: 'Corporate tax: UAE 9% (2023~), Korea 9~24%', uaeColor: 'green', whyItMatters: '9% corporate + 0% income tax minimizes burden. Note: 5% VAT applies; consider costs outside free zones.' },
