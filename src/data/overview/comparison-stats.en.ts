...
export const comparisonStats: readonly ComparisonRow[] = [
  { indicator: 'Political System', uae: 'Federal Absolute Monarchy (7 Emirates)', korea: 'Presidential Democratic Republic', note: 'UAE has no elections, political parties, or parliament' },
  ...
  { indicator: 'Population', uae: '~10.5M', korea: '~51.7M', note: '88.5% of UAE population are foreigners', uaeHighlight: true },
  { indicator: 'National Population', uae: '~1.2M (11.5%)', korea: '~51.7M', note: 'Actual Emiratis number roughly 1/3 of Busan\'s population', uaeColor: 'red' },
  ...
  { indicator: 'GDP per Capita', uae: '$49,500', korea: '$33,100', note: 'UAE is 1.5x higher', uaeColor: 'green' },
  { indicator: 'GDP Growth', uae: '4.0% (2024)', korea: '2.0% (2024)', note: 'UAE targets: 4.8% (2025), 5.7% (2026)' },
  { indicator: 'SWF Total Assets', uae: '$2.5T+', korea: '$890B (KIC+NPS)', note: 'UAE SWFs = 1.5x Korea\'s GDP', uaeHighlight: true },
  { indicator: 'Income Tax', uae: '0% (Tax-free)', korea: '6~45% Progressive', note: 'Corporate tax: UAE 9% (2023~), Korea 9~24%', uaeColor: 'green' },
  ...
  { indicator: 'Bilateral Relations', uae: 'CEPA in effect (May 2024) · 100-Year Strategic Partnership', korea: '', note: 'KEPCO nuclear $23.8B, Samsung Eng. $8B+' },
] as const
