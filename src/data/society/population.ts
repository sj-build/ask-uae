...
export const demographicStats: readonly DemographicStat[] = [
  { label: '총 인구', value: '~11.35M', note: '1971년 ~30만에서 50년 만에 40배 성장', icon: '👥' },
  { label: '외국인 비율', value: '~88.5%', note: '세계 3위 (카타르, 바티칸 다음)', icon: '🌍' },
  { label: '에미라티(자국민)', value: '~1.2M (11.5%)', note: '자국에서 소수민족인 유일한 주요 국가', icon: '🇦🇪' },
  { label: '남녀 비율', value: '남 63.8% : 여 36.2%', note: '남성 노동자 유입으로 극심한 불균형', icon: '⚤' },
...
export const nationalityGroups: readonly NationalityGroup[] = [
  ...
  },
  {
    ...
    percentage: 5,
    population: '~500K',
    characteristics: '역사적 무역 파트너. Dubai 상인 커뮤니티의 뿌리. Farsi 사용',
    color: '#ef4444',
  },
  {
    flag: '🇪🇬',
    ...
    percentage: 4,
    population: '~450K',
    characteristics: '최대 아랍 외국인 커뮤니티. 교육, 금융, 법률, 컨설팅',
    color: '#f472b6',
  },
  {
    flag: '🇦🇪',
  ...
  },
  {
    ...
    percentage: 2.5,
    population: '~250-300K',
    characteristics: '수적으로 소수이나, 시니어 경영진 비율 높음',
    color: '#4a9eff',
  },
  {
    flag: '🌍',
    name: '기타 아랍 (요르단/시리아/레바논 등)',
    percentage: 8,
    population: '다수',
    characteristics: '교육, 금융, 법률, 미디어 분야 활발',
    color: '#6b7280',
  },
] as const
