...
export const demographicStats: readonly DemographicStat[] = [
  { label: 'Total Population', value: '~11.35M', note: '40x growth in 50 years, from ~300K in 1971', icon: '👥' },
  { label: 'Foreign Nationals', value: '~88.5%', note: '3rd highest globally (after Qatar, Vatican)', icon: '🌍' },
  { label: 'Emiratis (Citizens)', value: '~1.2M (11.5%)', note: 'Only major country where nationals are a minority', icon: '🇦🇪' },
  { label: 'Gender Ratio', value: 'Male 63.8% : Female 36.2%', note: 'Extreme imbalance due to male labor migration', icon: '⚤' },
...
export const nationalityGroups: readonly NationalityGroup[] = [
  ...
  },
  {
    ...
    percentage: 5,
    population: '~500K',
    characteristics: 'Historical trade partner. Roots of Dubai merchant community. Farsi-speaking',
    color: '#ef4444',
  },
  {
    flag: '🇪🇬',
    ...
    percentage: 4,
    population: '~450K',
    characteristics: 'Largest Arab expatriate community. Education, finance, law, consulting',
    color: '#f472b6',
  },
  {
    flag: '🇦🇪',
  ...
  {
    flag: '🌐',
    name: 'Westerners (US/UK/Europe)',
    percentage: 2.5,
    population: '~250-300K',
    characteristics: 'Numerically small, but disproportionately represented in senior management',
    color: '#4a9eff',
  },
  {
    flag: '🌍',
    name: 'Other Arabs (Jordan/Syria/Lebanon, etc.)',
    percentage: 8,
    population: 'Large',
    characteristics: 'Active in education, finance, law, and media sectors',
    color: '#6b7280',
  },
] as const
