...
import type { TrendCategory } from '@/data/politics/trends'

interface PoliticalTrendsProps {
  readonly trends: readonly TrendCategory[]
}

export function PoliticalTrends({ trends }: PoliticalTrendsProps) {
